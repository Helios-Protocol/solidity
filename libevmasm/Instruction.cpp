...
std::map<std::string, Instruction> const dev::eth::c_instructions =
{
	...
	{ "EXECUTEONSEND", Instruction::EXECUTEONSEND },
	{ "TIMESTAMP", Instruction::TIMESTAMP },
	{ "NUMBER", Instruction::NUMBER },
	{ "CODEADDRESS", Instruction::CODEADDRESS },
    ...
    { "SURROGATECALL", Instruction::SURROGATECALL },
...
{ //												Add, Args, Ret, SideEffects, GasPriceTier
	...
	{ Instruction::EXECUTEONSEND,  {"EXECUTEONSEND",  0, 0, 1, false, Tier::Base } },
	{ Instruction::TIMESTAMP,      {"TIMESTAMP",      0, 0, 1, false, Tier::Base } },
	{ Instruction::NUMBER,         {"NUMBER",         0, 0, 1, false, Tier::Base } },
	{ Instruction::CODEADDRESS,     {"CODEADDRESS",     0, 0, 1, false, Tier::Base } },
