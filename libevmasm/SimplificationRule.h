...
struct EVMBuiltins
{
	...
	static auto constexpr EXECUTEONSEND = PatternGenerator<Instruction::EXECUTEONSEND>{};
	...
	static auto constexpr CODEADDRESS = PatternGenerator<Instruction::CODEADDRESS>{};
    ...
    static auto constexpr SURROGATECALL = PatternGenerator<Instruction::SURROGATECALL>{};
